...
@Singleton
@Component(modules = arrayOf(ApplicationModule::class, EsaServiceModule::class, RealmConfigurationModule::class, LoginProfileRepositoryModule::class, NavigationIdentifierRepositoryModule::class, TeamRepositoryModule::class))
